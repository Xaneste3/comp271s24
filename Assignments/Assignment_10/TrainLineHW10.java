public class TrainLineHW10 {
     ...
     */
    public void append(TrainLineHW10 other) {
    ...
    /**
     * Determines if two trainline objects intersect, if they both have a station
     ...
     */
    public boolean intersects(TrainLineHW10 other) {
